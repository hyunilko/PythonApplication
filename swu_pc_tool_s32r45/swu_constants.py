...
# CAN ID 상수
# ==============================================================================
# CAN_ID = (DeviceID << 8) | MSG_ID
# DeviceID = 0이면 CAN_ID = MSG_ID
DEFAULT_DEVICE_ID = 0

CAN_ID_COMMAND = 0x32   # Control/Verify 프레임
...
# ==============================================================================
PROGRESS_START = 0
PROGRESS_ACK_SWU_START = 1
PROGRESS_ACK_DOWNLOAD_START = 2
PROGRESS_DATA_START = 2
PROGRESS_DATA_END = 90
...
# CAN 명령어 (S32R45)
# ==============================================================================
CAN_CMD_RESET           = 0x403100
CAN_CMD_SENSOR_START    = 0x403200
CAN_CMD_SENSOR_STOP     = 0x403300
CAN_CMD_HI              = 0x403400
CAN_CMD_CAL_MODE        = 0x403500
CAN_CMD_OPR_MODE        = 0x403600
CAN_CMD_REQ_UNIQUE_ID   = 0x403700
CAN_CMD_REQ_OP_MODE     = 0x403800

# ACK 마스크
CAN_ACK_MASK = 0xAA

# OP_MODE 값
OP_MODE_OPR = 0  # OPR Mode
OP_MODE_CPT = 1  # Debug Capture Mode
OP_MODE_CAL = 2  # Calibration Mode
